    ...
    AbstractValidator<CreateCourseCommand>
{
    ...
    public override ValidationResult Validate(ValidationContext<CreateCourseCommand> context)
    {
        return context.InstanceToValidate.Course is null
            ? new ValidationResult(new[] {
                new ValidationFailure("CourseForCreationDto", "CourseForCreationDto object is null")
